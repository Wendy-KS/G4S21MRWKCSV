...
public class Conexion {
    ...
    private void Abrir(){
        ...
        String url="jdbc:mysql://localhost:3306/csv?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDateimeCode=false&serverTimezone=UTC";
         try {
   ...
   try{
        ...
        while(rs.next()){
            datos = new Datos(rs.getNString("nombre"),rs.getInt("edad"),rs.getString("sexo"),rs.getString("correo"),rs.getString("celular"),rs.getInt("id"));
